...
class resumeExtraction:
    ...
    def extractorData(self, file, ext):  #
        ...
        return {"name": name, "mobile": mobile_no, "email": email, "skills": skills, "text": text1}
...
result =resumeExtractor.extractorData(fitz.open(r"C:\Users\SAFAN\OneDrive\Desktop\Resume\SafvanCK_Updated_Resume.pdf"),"pdf")
